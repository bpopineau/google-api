...
## Phase 1: Core Configuration & Persistence [checkpoint: completed]
...
- [x] **Task 1: Refactor Stylesheet Generation**
...
- [x] **Task 2: Implement Theme Manager**
...
- [x] **Task 3: Unit Test Theming Logic**
...
## Phase 2: Dynamic Theming Engine [checkpoint: completed]
...
- [x] **Task 1: Refactor SettingsPage Layout**
...
- [x] **Task 2: Implement Appearance Section**
...
- [x] **Task 3: Add Section Placeholders**
    - Implement basic layouts for "General", "Accounts", and "Sync" sections as specified.
- [x] **Task 4: Functional Tests for Settings UI**
    - Create `tests/gui/test_theme_manager.py`.
    - Verify that changing theme/accent in the UI updates the `AppConfig`.
- [x] **Task 5: Conductor - User Manual Verification 'Phase 3' (Protocol in workflow.md)**

## Phase 3: Structured Settings UI [checkpoint: completed]

## Phase 4: Integration & Polish
Ensure the theme is applied globally and consistently.

- [x] **Task 1: Apply Theme on App Startup**
    - Update `mygoog_gui/main.py` to initialize `ThemeManager` and apply the saved theme before showing the main window.
- [x] **Task 2: Final Verification & Cleanup**
    - Run full test suite.
    - Verify "Hackability" (manual config edit reflected on restart).
- [x] **Task 3: Conductor - User Manual Verification 'Phase 4' (Protocol in workflow.md)**

## Phase 4: Integration & Polish [checkpoint: completed]